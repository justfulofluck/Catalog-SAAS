      ...
      <div className="px-6 py-4 bg-[#161616] border-b border-[#262626] flex flex-wrap items-center justify-between gap-4 shrink-0">
        <div className="flex flex-col min-w-[200px]">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-semibold text-white tracking-tight leading-none font-heading">Edit Product</h1>
          </div>
          <p className="text-xs text-[#888888] font-normal mt-1 ml-7">
            Refine metadata for <span className="text-[#E2DCC8] font-semibold">{productToEdit.name}</span>.
          </p>
        </div>
              ...
              <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center ml-1">
                      ...
                      <label htmlFor="edit-multi-prod-img" className="text-[9px] font-bold text-[#E2DCC8] uppercase tracking-widest flex items-center gap-1 cursor-pointer hover:text-[#E2DCC8]">
                    ...
                    <div className="flex gap-2">
                      ...
                      <label htmlFor="edit-prod-img-dynamic" className="flex-1 flex items-center justify-center gap-1.5 bg-[#0F3D3E] hover:bg-[#155455] border border-[#E2DCC8]/30 text-white rounded-[4px] px-3 py-2 text-[11px] font-bold uppercase tracking-wider cursor-pointer transition-all shadow-sm shadow-[#0F3D3E]/20 active:scale-95">
                      ...
                      <label htmlFor="edit-multi-prod-img" className="flex-1 flex items-center justify-center gap-1.5 bg-[#1c1c1c] hover:bg-[#262626] text-[#999999] hover:text-white rounded-[4px] px-3 py-2 text-[11px] font-bold uppercase tracking-wider cursor-pointer transition-all border border-[#262626]">
                  ...
                  <div className="space-y-1.5 pt-3 border-t border-[#262626]">
                    ...
                    <div className="relative group">
                      <Hash className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#666666]" size={15} />
                      <input
                        type="text"
                        value={formData.sku}
                        onChange={(e) => handleInputChange('sku', e.target.value)}
                        className="w-full border rounded-[4px] pl-9 pr-4 py-2 text-xs font-semibold outline-none transition-all bg-[#1c1c1c] border-[#262626] text-white"
              ...
              <div className="bg-[#161616] rounded-[4px] border border-[#262626] p-8 md:p-10 space-y-10">
                <section className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input type="text" required value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} className="w-full bg-[#1c1c1c] border border-[#262626] rounded-[4px] px-6 py-4 text-lg font-bold text-white focus:border-[#0F3D3E] outline-none" placeholder="e.g. Premium Executive Desk" />
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold text-[#888888] uppercase tracking-widest ml-1">SKU / ID</label>
                      <div className="relative"><Hash className="absolute left-4 top-1/2 -translate-y-1/2 text-[#666666]" size={18} /><input type="text" required value={formData.sku} onChange={(e) => setFormData({ ...formData, sku: e.target.value })} className="w-full bg-[#1c1c1c] border border-[#262626] rounded-[4px] pl-12 pr-6 py-4 text-base font-bold text-white focus:border-[#0F3D3E] outline-none" placeholder="OFC-99-A" /></div>
                    </div>
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold text-[#888888] uppercase tracking-widest ml-1">Category Classification</label>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-[#161616] rounded-[4px] p-8 space-y-6 text-white relative overflow-hidden border border-[#262626]">
                ...
                <div className="space-y-4 relative z-10">
                  ...
                  <div className="p-4 bg-[#0F3D3E]/10 border border-[#0F3D3E]/20 rounded-[4px] flex items-start gap-3"><Info size={16} className="text-[#E2DCC8] shrink-0 mt-0.5" /><p className="text-[10px] font-medium text-[#dddddd] leading-relaxed">Changes here affect the SKU globally across all publications using this product.</p></div>
                </div>
              </div>
            </div>
          </div>
