...
import { ArrowLeft, Save, Hash, AlignLeft, Image as ImageIcon, DollarSign, FolderTree, ChevronDown, Package, Info, Upload, Layers, CreditCard, RefreshCcw } from 'lucide-react';
...
const EditProductForm: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (activeTemplate) {
      ...
      finalProduct.image = formData.image;
      finalProduct.categoryId = formData.categoryId || undefined;
    }
                  ...
                  <div className="space-y-2 pt-4 border-t border-slate-50 dark:border-slate-700">
                    ...
                    <div className="relative group">
                      ...
                      <input
                        ...
                        className="w-full border rounded-2xl pl-12 pr-6 py-4 text-base font-bold outline-none transition-all bg-slate-50 border-slate-200 text-slate-800"
