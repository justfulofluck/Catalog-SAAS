...
const EditProductForm: React.FC = () => {
  const { setView, updateProduct, categories, products, editingProductId, setEditingProductId, uiTheme, addMedia } = useStore();
      ...
      <div className={`px-6 py-4 border-b flex flex-wrap items-center justify-between gap-4 shrink-0 ${
        ...
        <div className="flex flex-col min-w-[200px]">
          ...
          <p className={`text-xs font-normal mt-1 ml-7 ${
            ...
            Refine metadata for <span className={`${isDark ? "text-[#E2DCC8]" : "text-[#0F3D3E]"} font-semibold`}>{productToEdit.name}</span>.
          </p>
        </div>
              ...
              <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center ml-1">
                      ...
                      <label htmlFor="edit-multi-prod-img" className={`text-[9px] font-bold uppercase tracking-widest flex items-center gap-1 cursor-pointer ${
                    ...
                    <div className="flex gap-2">
                      ...
                      <label htmlFor="edit-multi-prod-img" className={`flex-1 flex items-center justify-center gap-1.5 rounded-[4px] px-3 py-2 text-[11px] font-bold uppercase tracking-wider cursor-pointer transition-all border ${
                  ...
                  <div className={`space-y-1.5 pt-3 border-t ${isDark ? 'border-[#262626]' : 'border-slate-200'}`}>
                    ...
                    <div className="relative group">
                      <Hash className={`absolute left-3.5 top-1/2 -translate-y-1/2 ${isDark ? 'text-[#666666]' : 'text-slate-400'}`} size={15} />
                      <input
                        type="text"
                        value={formData.sku}
              ...
              <div className={`rounded-[4px] border p-8 md:p-10 space-y-10 ${
                ...
                <section className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className={`text-[10px] font-bold uppercase tracking-widest ml-1 ${isDark ? 'text-[#888888]' : 'text-slate-500'}`}>SKU / ID</label>
                      <div className="relative">
              ...
              <div className={`rounded-[4px] p-8 space-y-6 relative overflow-hidden border ${
                ...
                <div className="space-y-4 relative z-10">
                  ...
                  <div className={`p-4 rounded-[4px] flex items-start gap-3 border ${
                    ...
                    <p className="text-[10px] font-medium leading-relaxed">Changes here affect the SKU globally across all publications using this product.</p>
                  </div>
                </div>
              </div>
            </div>
