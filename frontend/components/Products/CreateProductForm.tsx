...
const CreateProductForm: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (activeTemplate) {
      ...
      if (!finalProduct.image && formData.image) finalProduct.image = formData.image;
      ...
      finalProduct.name = formData.name || 'Untitled';
      finalProduct.price = parseFloat(formData.price) || 0;
      finalProduct.description = formData.description;
      if (formData.image) finalProduct.image = formData.image;
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            ...
            <h1 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight leading-none mb-2">New Product Entry</h1>
