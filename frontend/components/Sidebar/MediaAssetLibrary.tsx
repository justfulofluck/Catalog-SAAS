...
const MediaAssetLibrary: React.FC = () => {
  const { mediaItems, addElement, currentPageIndex, addMedia, setDraggingItem } = useStore();
        ...
        {filteredMedia.length === 0 ? (
          ...
          filteredMedia.map((item) => (
            <div 
              ...
              className="group aspect-square rounded-[24px] bg-slate-50 overflow-hidden relative border border-slate-100 hover:border-indigo-600 transition-all cursor-grab active:cursor-grabbing shadow-sm hover:shadow-2xl hover:shadow-indigo-600/10"
