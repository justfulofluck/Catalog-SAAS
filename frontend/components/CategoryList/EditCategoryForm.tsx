              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3 pt-3 border-t border-slate-100 dark:border-slate-800">
                  <div className="flex justify-between items-center ml-1">
                    ...
                    <label htmlFor="edit-cat-multi-img" className="text-[9px] font-black text-indigo-600 dark:text-indigo-400 uppercase tracking-widest flex items-center gap-1 cursor-pointer hover:text-indigo-700">
                  ...
                  <div className="flex gap-2">
                    ...
                    <label htmlFor="edit-cat-thumb-upload" className="flex-1 flex items-center justify-center gap-1.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl px-3 py-2 text-[11px] font-black uppercase tracking-wider cursor-pointer transition-all shadow-sm shadow-indigo-600/20 active:scale-95">
