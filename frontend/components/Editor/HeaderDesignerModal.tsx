...
export const HeaderDesignerModal: React.FC = () => {
  ...
  useEffect(() => {
    ...
    canvas.on('object:modified', (e: any) => {
      ...
      if (isDivider) {
        // Horizontal divider lines only stretch in width, never rotate or distort in height
  ...
  const addShapeElement = (shapeType: ShapeType) => {
    ...
    const w = isLine ? 300 : isPill ? 90 : isArrow ? 60 : 36;
    const h = isLine ? 2 : isPill ? 24 : isArrow ? 20 : 36;
