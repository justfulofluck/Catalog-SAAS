...
export const GradientBlinds: React.FC<GradientBlindsProps> = ({
  ...
  dpr,
  paused = false,
  gradientColors = ['#0F3D3E', '#165B5D', '#3B82F6', '#E2DCC8'],
  angle = 0,
  noise = 0.3,
  blindCount = 16,
  blindMinWidth = 60,
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    vec2 offset = vec2(iMouse.x/iResolution.xy.x, iMouse.y/iResolution.xy.y);
...
`;
    ...
    return () => {
      ...
      callIfFn(mesh as unknown as { remove?: () => void }, 'remove');
      callIfFn(renderer as unknown as { destroy?: () => void }, 'destroy');
    };
  }, [
    dpr,
    paused,
