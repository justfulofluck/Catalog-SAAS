        ...
        <nav className="flex-1 px-4 space-y-1 overflow-y-auto">
          ...
          {user?.businessId && isSidebarExpanded && (
            <div className="px-4 py-2">
              <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1">Business Template</p>
              <p className="text-xs font-bold text-slate-300 truncate">{businessTemplates.find(t => t.id === user.businessId)?.name || 'Default'}</p>
            </div>
          )}
        </nav>
